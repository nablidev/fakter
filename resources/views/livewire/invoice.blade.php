    ...
    <form wire:submit.prevent="submit">
        <div class="flex flex-wrap mx-3 my-8">
            ...
            <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
                ...
                <input wire:keyup="$emit('priceUpdated')" wire:model="price" id="price" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="119">
            </div>
            <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
            ...
            <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
                ...
                <input value="{{$price_ev}}" wire:model="price_ev" id="price_ev" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="100">
            </div>
            <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
