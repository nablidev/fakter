        ...
        <div class="flex flex-wrap mx-3 my-8">
            <div class="w-full md:w-2/6 px-3 mb-6 md:mb-0">
                <div class="flex flex-col items-center">
                    <label class="truncate uppercase tracking-wide text-gray-700 text-base font-bold mb-2" for="item-name">
                        Item Name
                    </label>
            ...
            <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
                <div class="flex flex-col items-center">
                    <label class="truncate uppercase tracking-wide text-gray-700 text-base font-bold mb-2" for="price">
                        Price
                    </label>
            ...
            <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
                <div class="flex flex-col items-center">
                    <label class="truncate uppercase tracking-wide text-gray-700 text-base font-bold mb-2" for="item-vat-percent">
                        VAT %
                    </label>
            ...
            <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
                <div class="flex flex-col items-center">
                    <label class="truncate uppercase tracking-wide text-gray-700 text-base font-bold mb-2" for="price_ev">
                        Price .exc VAT
                    </label>
            ...
            <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
                <div class="flex flex-col items-center">
                    <label class="truncate uppercase tracking-wide text-gray-700 text-base font-bold mb-2" for="quantity">
                        Quantity
                    </label>
